...
type TProperties<T extends { [key: string]: unknown }, key extends keyof T> = T[key] extends number ? TNumberJSONSchema : T[key] extends string ? TStringJSONSchema : TJSONSchema;
