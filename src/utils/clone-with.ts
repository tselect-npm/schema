...
type TCloneWithReturn<O extends (T extends TObjectJSONSchema ? TObjectJSONSchema : Partial<T>), T extends TJSONSchema = TJSONSchema> = O extends TObjectJSONSchema<infer U> ? TObjectJSONSchema<U> & Omit<T, 'required' | 'properties'> : T & O;
